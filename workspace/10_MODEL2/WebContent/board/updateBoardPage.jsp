	...
	$(document).ready(function(){
		/*
			...
			f.submit(function(e){
				...
				if(title.val() == '${param.title}' && content.val() == '${param.content}' && file == '${param.filename}'){
					alert('수정할 내용이 없습니다');
					e.preventDefault();
					return false;
				}
...
<div class="update_form">
	...
	<form action="/10_MODEL2/updateBoard.b" id="f" method="post" enctype="multipart/form-data">
		...
		<div class="btns">
			...
			<input type="reset" class="btn" value="수정초기화" id="reset_btn">
			<input type="button" class="btn" value="목록보기" id="list_btn">
		</div>
	</form>
